...
- Ajv-based raw-schema consumer recipes, including CommonJS/ESM/TypeScript installed-package contract-validation, archive validation, bundled-schema validation, invalid-capsule rejection, invalid archive rejection, and invalid validator-envelope rejection flows, their human guides, and repo-local verifiers
...
- manifest coverage: `413` files / `413` manifest entries
