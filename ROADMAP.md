...
- improve onboarding for external contributors and integrators
  ...
  Deepened further through [`docs/openapi-codegen-recipes.md`](docs/openapi-codegen-recipes.md), [`examples/client/openapi-generate-validator-types.mjs`](examples/client/openapi-generate-validator-types.mjs), [`examples/client/esm-package-openapi-codegen.mjs`](examples/client/esm-package-openapi-codegen.mjs), and [`scripts/check-openapi-codegen.js`](scripts/check-openapi-codegen.js), so tool-builders now have a verifier-backed `openapi-typescript` path from both repo and installed-package surfaces instead of stopping at direct OpenAPI inspection.
