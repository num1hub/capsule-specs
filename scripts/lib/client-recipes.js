...
const supportedTaskRuntimes = ['shell', 'node', 'typescript', 'zod', 'ajv', 'python', 'cjs', 'esm'];

const recipeGroups = [
  {
    id: 'shell-live-validator',
    title: 'cURL live validator routes',
    description: 'Minimal shell entrypoints for the published validator HTTP routes with bearer auth.',
    audiences: ['integrators', 'contributors'],
    primary_docs: ['docs/client-recipes.md', 'docs/route-reference.md'],
    recommended_start: 'curl-validate-single.sh',
    files: shellFiles
  },
  {
    id: 'node-live-validator',
    title: 'Node live validator routes',
    description: 'Small fetch-based runtime clients for the published validator routes.',
    audiences: ['integrators', 'contributors'],
    primary_docs: ['docs/client-recipes.md', 'docs/integration-guide.md'],
    recommended_start: 'node-validate-single.mjs',
    files: nodeFiles
  },
  {
  ...
  },
  {
    ...
    description: 'Repo-local and package-level Ajv consumers for positive validation and structural rejection.',
    audiences: ['integrators', 'tool-builders'],
    ...
    files: schemaRecipeFiles
  },
  {
    id: 'integrity-recipes',
    title: 'Integrity seal recipes',
    description: 'Public G16 recomputation and teaching-example repair flows.',
    audiences: ['integrators', 'reviewers'],
    primary_docs: ['docs/integrity-recipes.md'],
    recommended_start: 'recompute-integrity-seal.mjs',
    files: integrityRecipeFiles
  },
  {
    id: 'python-consumers',
    title: 'Python consumers',
    description: 'Cross-language readers, parsers, and live validator flows from repo and packed artifacts.',
    audiences: ['integrators', 'tool-builders'],
    primary_docs: ['docs/python-consumption.md', 'docs/client-recipes.md'],
    recommended_start: 'python-live-validator-client.py',
    files: pythonRecipeFiles
  },
  {
    id: 'package-runtime',
  ...
  },
  {
    ...
    files: packageTypeRecipeFiles
  }
];

const taskEntrypoints = [
  {
    id: 'live-validate-single',
    intent: 'Send one capsule to POST /api/validate',
    primary_group: 'shell-live-validator',
    recommended: 'curl-validate-single.sh',
    alternatives: ['node-validate-single.mjs', 'python-validate-single.py', 'ts-live-validator-client.ts'],
    docs: ['docs/client-recipes.md', 'docs/route-reference.md', 'docs/integration-guide.md'],
    runtimes: ['shell', 'node', 'python', 'typescript']
  },
  {
    id: 'live-validate-batch',
    intent: 'Send a batch payload to POST /api/validate/batch',
    primary_group: 'shell-live-validator',
    recommended: 'curl-validate-batch.sh',
    alternatives: ['node-validate-batch.mjs', 'python-validate-batch.py', 'ts-live-validator-client.ts'],
    docs: ['docs/client-recipes.md', 'docs/route-reference.md', 'docs/integration-guide.md'],
    runtimes: ['shell', 'node', 'python', 'typescript']
  },
  {
    id: 'live-validate-fix',
    intent: 'Send a fix payload to POST /api/validate/fix',
    primary_group: 'shell-live-validator',
    recommended: 'curl-validate-fix.sh',
    alternatives: ['node-validate-fix.mjs', 'python-validate-fix.py', 'ts-live-validator-client.ts'],
    docs: ['docs/client-recipes.md', 'docs/route-reference.md', 'docs/integration-guide.md'],
    runtimes: ['shell', 'node', 'python', 'typescript']
  },
  {
    id: 'live-support-routes',
    intent: 'Call the published gates and stats support routes',
    primary_group: 'shell-live-validator',
    recommended: 'curl-get-gates.sh',
    alternatives: ['node-get-gates.mjs', 'python-get-gates.py', 'curl-get-stats.sh', 'node-get-stats.mjs', 'python-get-stats.py'],
    docs: ['docs/client-recipes.md', 'docs/route-reference.md', 'docs/integration-guide.md'],
    runtimes: ['shell', 'node', 'python']
  },
  {
    id: 'node-live-clients',
    intent: 'Use small Node fetch clients for the published validator routes without package installation',
    primary_group: 'node-live-validator',
    recommended: 'node-validate-single.mjs',
  ...
  },
  {
    ...
    intent: 'Read or type published validator request samples from source-level projections',
    primary_group: 'source-level-types',
    recommended: 'ts-parse-validate-requests.ts',
    alternatives: ['zod-parse-validate-request.ts', 'zod-parse-validate-batch-request.ts', 'zod-parse-validate-fix-request.ts'],
    docs: ['docs/client-recipes.md', 'docs/type-projections.md', 'docs/api-envelopes.md'],
    runtimes: ['typescript', 'zod']
  },
  {
    id: 'source-response-reading',
    intent: 'Read published validate, error, and support responses from source-level projections',
    primary_group: 'source-level-types',
    recommended: 'ts-parse-validate-responses.ts',
    alternatives: ['ts-parse-error-responses.ts', 'ts-parse-support-responses.ts', 'zod-parse-validate-response.ts', 'zod-parse-error-responses.ts'],
    docs: ['docs/client-recipes.md', 'docs/type-projections.md', 'docs/api-envelopes.md'],
    runtimes: ['typescript', 'zod']
  },
  {
    id: 'raw-schema-validation',
  ...
  },
  {
    ...
    intent: 'Read compact contract constants, route behavior, and envelope families before deeper integration',
    primary_group: 'source-level-types',
    recommended: 'ts-envelope-family-reference.ts',
    alternatives: ['ts-route-behavior-reference.ts', 'python-contract-reference.py', 'cjs-package-contract-reference.cjs', 'esm-package-contract-reference.mjs', 'ts-package-contract-reference.ts'],
    docs: ['docs/reference-pack.md', 'docs/client-recipes.md'],
    runtimes: ['typescript', 'python', 'cjs', 'esm']
  },
  {
    id: 'openapi-direct-consumption',
    intent: 'Read the strongest published HTTP contract or generate TypeScript declarations from it',
    primary_group: 'source-level-types',
    recommended: 'ts-openapi-route-summary.ts',
    alternatives: ['python-openapi-reference.py', 'esm-package-openapi-reference.mjs', 'openapi-generate-validator-types.mjs', 'ts-package-openapi-codegen.ts'],
    docs: ['docs/openapi.md', 'docs/openapi-codegen-recipes.md', 'docs/client-recipes.md'],
    runtimes: ['typescript', 'python', 'esm', 'node']
  },
  {
    id: 'package-live-clients',
    intent: 'Use installed-package live validator clients instead of repo-relative imports',
  ...
  {
    id: 'package-typescript-flows',
    intent: 'Use installed-package TypeScript request, response, and OpenAPI entrypoints from one typed lane',
    primary_group: 'package-typescript',
    recommended: 'ts-package-live-validator-client.ts',
  ...
  },
  {
    ...
    intent: 'Use Python for compact references, live routes, and response-side parsing without Node imports',
    primary_group: 'python-consumers',
    recommended: 'python-live-validator-client.py',
    alternatives: ['python-contract-reference.py', 'python-openapi-reference.py', 'python-parse-validate-responses.py', 'python-parse-error-responses.py', 'python-parse-support-responses.py'],
    docs: ['docs/python-consumption.md', 'docs/client-recipes.md', 'docs/integration-guide.md'],
    runtimes: ['python']
  },
  {
    id: 'integrity-proof',
    intent: 'Recompute published integrity hashes and inspect the public G16 seal boundary',
    primary_group: 'integrity-recipes',
    recommended: 'recompute-integrity-seal.mjs',
    alternatives: ['python-recompute-integrity-seal.py', 'esm-package-recompute-integrity-seal.mjs'],
    docs: ['docs/integrity-recipes.md', 'docs/client-recipes.md'],
    runtimes: ['node', 'python', 'esm']
  }
];
...
const recipeIndex = {
  ...
  groups: recipeGroups.map((group) => ({
    ...
    primary_docs: group.primary_docs,
    recommended_start: group.recommended_start,
    files: group.files
  })),
  task_entrypoints: taskEntrypoints
};
