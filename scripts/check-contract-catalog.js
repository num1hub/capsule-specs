...
const requiredIds = [
  ...
  'projection.typescript-client-recipe-index',
  ...
  'examples.client.ts-client-recipe-index',
  'examples.client.ts-openapi-route-summary',
  'examples.client.recipe-index',
  'examples.client.ajv-validate-client-recipe-index',
  ...
  'examples.client.cjs-package-client-recipe-index',
  'examples.client.cjs-package-openapi-codegen',
  ...
  'examples.client.esm-package-client-recipe-index',
  'examples.client.esm-package-ajv-validate-client-recipe-index',
  ...
  'examples.client.ts-package-client-recipe-index',
  'examples.client.ts-package-openapi-codegen',
  'examples.client.ts-package-openapi-reference',
