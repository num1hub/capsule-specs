...
const packageRecipePath = path.join(repoRoot, 'examples', 'client', 'esm-package-ajv-reject-invalid-validator-envelopes.mjs');
...
assert(fs.existsSync(packageRecipePath), 'missing package invalid API recipe');
