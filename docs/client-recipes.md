...
- Validate or reject assets directly against raw schemas:
  start with [`ajv-validate-capsule.mjs`](../examples/client/ajv-validate-capsule.mjs) for capsule validation, [`ajv-validate-client-recipe-index.mjs`](../examples/client/ajv-validate-client-recipe-index.mjs) or [`cjs-package-ajv-validate-client-recipe-index.cjs`](../examples/client/cjs-package-ajv-validate-client-recipe-index.cjs) for navigator validation, and [`ajv-reject-invalid-capsules.mjs`](../examples/client/ajv-reject-invalid-capsules.mjs) or [`ts-package-ajv-reject-invalid-client-recipe-index.ts`](../examples/client/ts-package-ajv-reject-invalid-client-recipe-index.ts) for structural rejection
...
- Use Python as the main cross-language bridge:
  start with [`python-client-recipe-index.py`](../examples/client/python-client-recipe-index.py) if you want the Python navigator first, then move to [`python-live-validator-client.py`](../examples/client/python-live-validator-client.py) and the request, response, and contract-reference helpers
...
- Python navigator: [`python-client-recipe-index.py`](../examples/client/python-client-recipe-index.py)
...
- [`openapi-generate-validator-types.mjs`](../examples/client/openapi-generate-validator-types.mjs)
