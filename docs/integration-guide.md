...
If you need bounded generic, unauthorized, forbidden, conflict, or rate-limit envelope handling, start with the public error-response recipes under [`../examples/client/`](../examples/client/).
