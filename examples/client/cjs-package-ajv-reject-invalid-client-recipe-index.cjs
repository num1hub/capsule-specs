...
const missingFiles = require("@num1hub/capsule-specs/examples/client-invalid/client-recipe-index.missing-files.json");
const invalidRuntime = require("@num1hub/capsule-specs/examples/client-invalid/client-recipe-index.invalid-runtime.json");
