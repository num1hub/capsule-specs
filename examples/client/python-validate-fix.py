...
payload = load_json("examples/api/validate-request.fix.json")
...
if base_url and token:
    ...
    summary.update(
        {
            "mode": "dry-run",
            "nextStep": "Set N1HUB_BASE_URL and N1HUB_TOKEN to send the published fix envelope to a live validator.",
        }
    )
